...
export function Hero() {
  return (
    <section className="relative flex w-full flex-col overflow-hidden bg-gradient-to-b from-navy-900 via-navy-900 via-60% to-navy-700">
      <div
        aria-hidden
      ...
      <div className="relative z-10 mt-8 flex flex-col gap-5 px-6">
      ...
      <div className="relative z-10 mt-10 flex flex-col gap-4 border-t border-navy-700 p-6">
        <span className="text-label font-semibold text-gold-500">
          CREDENCIAIS
        </span>
